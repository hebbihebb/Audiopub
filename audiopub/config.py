...
DEFAULT_USE_GPU = True # Enable GPU acceleration by default (if available)
DEFAULT_GPU_QUALITY_STEPS = 16 # Quality steps for GPU mode (16 = default quality, 32 = high quality)
